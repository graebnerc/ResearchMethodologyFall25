---
title: "🗓️ Session 6: Data preparation"
date: "2025-10-24"
...
[here](/content/material/slides/E6-DataPreparation.pdf) to download the slides.


```{=html}
<div class="embed-container">
  <iframe 
  src="/content/material/slides/E6-DataPreparation.pdf" 
  style="border: 0.5px" 
  width="80%"
  height="80%"
  ></iframe>
...
make a line graph.
    - [ZIP file](/content/material/session06-solution.zip) with a possible solution^[You can ignore the `make_co2_data.R` for now and only look at `make_co2_plot.R`.]
